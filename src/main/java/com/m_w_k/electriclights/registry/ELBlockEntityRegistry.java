...
public class ELBlockEntityRegistry {
    ...
    public static final RegistryObject<BlockEntityType<GeothermalBlockEntity>> GEOTHERMAL_GENERATOR = BLOCK_ENTITIES.register("geothermal_generator", () -> BlockEntityType.Builder.of(GeothermalBlockEntity::new, GEOTHERMAL_BLOCK.get()).build(null));
}
