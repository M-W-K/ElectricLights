...
public class ELBlocksRegistry {
    ...
    public static final RegistryObject<Block> ELECTRIC_RELAY = BLOCKS.register("electric_relay", () -> new ElectricRelayBlock(Block.Properties.copy(Blocks.LANTERN).lightLevel((a) -> 0)));
